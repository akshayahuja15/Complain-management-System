...
if(strlen($_SESSION['login'])==0)
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $course=$_POST['course'];
        $sap_id=$_POST['sap_id'];
        $query=mysqli_query($bd, "update users set fullName='$fname',contactNo='$contactno',address='$address',course='$course',sap_id='$sap_id' where userEmail='".$_SESSION['login']."'");
        if($query)
        {
                        ...
                        while($row=mysqli_fetch_array($query))
                        {
                            ...
                            <form class="form-horizontal style-form" method="post" name="profile" >
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-2 col-sm-2 control-label">SAP ID</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="sap_id" maxlength="9" required="required" value="<?php echo htmlentities($row['SAP_ID']);?>" class="form-control">
                                    </div>
                                </div>
