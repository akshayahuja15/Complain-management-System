    ...
    <!-- <div class="container"> -->
        ...
        <div class="navbar-header">
            ...
            <a class="" href="http://localhost:81/Complaint%20Management%20System/users/">
                <img src="assets/img/CampusCareLogo.png" alt="Logo" style="width: 150px; height: auto;">
            </a>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-6">
            <!-- Move the login box to the right -->
            <div id="login-page">
                <form class="form-login" method="post">
                    ...
                    <div class="login-wrap">
                        ...
                        <input type="text" class="form-control" maxlength="10" name="contactno"
                               placeholder="Contact no" required="required" autofocus><br>
